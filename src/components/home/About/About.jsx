  ...
  return (
    <section className={styles.about}>
        ...
        <div className={styles.card}>
          ...
          <ul className={styles.contactList}>
            <li>
              ...
              <span>(+91) 9058735424</span>
            </li>
            <li>
              <span className={styles.icon}><MdMailOutline /></span>
              <span>FoodySite254@gmail.com</span>
            </li>
            <li>
              <span className={styles.icon}><HiOutlineLocationMarker /></span>
              <span>350 Pocket-1 Paschim vihar New Delhi</span>
            </li>
          </ul>
        </div>
      </div>
      ...
      <div className={styles.text}><br />
        ...
        <Link className={styles.link} to="/about"><button>More About Us</button></Link>
      </div>
    </section>
  )
}
