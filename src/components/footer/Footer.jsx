      ...
      <div className={styles['footer-container']}>
        <div className={styles.left}>
          ...
          <div className={styles.socials}>
            ...
            <Link className={styles.socialBtn} to="https://www.linkedin.com/in/suyash-sharma-b94373246" target="_blank" rel="noreferrer" aria-label="linkedin"><FaLinkedinIn /></Link>
          </div>
        </div>
